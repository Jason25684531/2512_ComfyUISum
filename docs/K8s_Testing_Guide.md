...
| 環節 | 文件位置 | 耗時 |
|------|---------|------|
| [K8s 架構概覽](#-k8s-架構與設計) | 第 2 節 | 5 分鐘 |
| [系統啟動](#啟動程序) | 第 3 節 | 15-20 分鐘 |
| [系統關閉](#關閉程序) | 第 4 節 | 5 分鐘 |
| [工作流執行](#執行測試流程) | 第 5 節 | 20-30 分鐘 |
| [除錯技巧](#除錯完整指南) | 第 6 節 | 視需求 |
| [前後端整合](#前後端整合測試) | 第 7 節 | 30 分鐘 |
| [完整檢查清單](#完整測試檢查清單) | 第 8 節 | 1 小時 |
