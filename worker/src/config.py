...
def print_config():
    ...
    print(f"  COMFY_SUBMIT_TIMEOUT_SECONDS: {COMFY_SUBMIT_TIMEOUT_SECONDS}")
    print(f"  COMFY_WS_WAIT_TIMEOUT_SECONDS: {COMFY_WS_WAIT_TIMEOUT_SECONDS}")
    print(f"  COMFY_HISTORY_TIMEOUT_SECONDS: {COMFY_HISTORY_TIMEOUT_SECONDS}")
    print(f"  OUTPUT_COPY_RETRY_COUNT: {OUTPUT_COPY_RETRY_COUNT}")
    print(f"  OUTPUT_COPY_RETRY_DELAY_SECONDS: {OUTPUT_COPY_RETRY_DELAY_SECONDS}")
    print(f"  OUTPUT_COPY_WAIT_SECONDS: {OUTPUT_COPY_WAIT_SECONDS}")
